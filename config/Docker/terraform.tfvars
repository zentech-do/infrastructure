...
subnet_id = [
  "10.0.2.0/24" # Replace with your public subnet CIDR, e.g., "192.168.3.0/24"  # Add additional public subnets as needed
]
...
key_name = "docker_aws"  # Replace with the name of your SSH key pair
