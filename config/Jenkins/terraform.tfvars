...
subnet_id = [
  "10.0.1.0/24" # Replace with your public subnet CIDR, e.g., "192.168.3.0/24"  # Add additional public subnets as needed
]
...
local_ip = "171.252.155.195"  # Change to your actual local IP address, e.g., "192.168.1.100"
